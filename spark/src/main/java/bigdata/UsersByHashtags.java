...
public class UsersByHashtags {
	...
	public static void createHBaseTable(JavaPairRDD<String,Tuple2<ArrayList<String>,Integer>> rdd,JavaSparkContext context) {
		...
		try {
			...
			JavaPairRDD<Integer,Tuple2<ArrayList<String>,String>> tmpRdd = 
				rdd.mapToPair(t-> new Tuple2<Integer,Tuple2<ArrayList<String>,String>>(t._2._2, new Tuple2<ArrayList<String>,String>(t._2._1,t._1))).sortByKey(false);
